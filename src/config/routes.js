...
export const ROUTES = {
  ...
  POTREBUJEM_POMOC_BASE: '/potrebujem-pomoc',
  POTREBUJEM_POMOC: [
  ...
  VYBERTE_VASE_MESTO_OLD: '/vyberte-vase-mesto',
  VYBERTE_VASE_MESTO: '/potrebujem-pomoc/vyberte-vase-mesto',
  KONTAKT: '/#kontakt',
  O_NAS: '/o-nas',
