module.exports = {
  theme: {
    ...
    extend: {
      boxShadow: {
        "default-sheer":
          "0 0 3px 0 rgba(0, 0, 0, .1), 0 1px 2px 0 rgba(0, 0, 0, .06)",
        "md-sheer":
          " 0 0 6px -1px rgba(0, 0, 0, .1), 0 2px 4px -1px rgba(0, 0, 0, .06)",
        "lg-sheer":
          " 0 0 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05)",
        "xl-sheer":
          " 0 0 25px -5px rgba(0, 0, 0, .1), 0 10px 10px -5px rgba(0, 0, 0, .04)",
